declare module 'mention-global-module' {
    ...
    class Router {
        ...
        getHash(): string
        go(route: RouterRoute, routeOpts?: RouterRouteOpts, opts?: RouterNavigateOpts): void
    ...
    type RouterMode = 'app' | 'headless' | 'login' | 'outOfApp'
    ...
    type RouterRoute = string

    type RouterRouteOpts = {
        readonly [x: string]: string | number | boolean | undefined | null
    }

    type RouterNavigateOpts = {
        reallyForce?: boolean
        trigger?: boolean
        replace?: boolean
    }

    let __exports: AppInterface
    export = __exports
}

declare var App: import('mention-global-module')
